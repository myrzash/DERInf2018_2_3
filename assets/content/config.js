const DATAS = {
    ru: {
        ...
        // CHANGABLE
        title: "Представление и измерение информации: Передача информации. Источник и приемник.",
        grade: "6 класс",
        typeder: "Тренажер",
        // intro: {
        //     chat: [
        ...
        parts: [
            {
                title: 'Что объединяет эти ситуации?',
                interactive: {
                    name: 'video-text',
                    items: [
                        {
                            video: {
                                src: 'assets/video/Animation_04.mp4',
                            },
                            text: 'Подумайте, что объединяет эти ситуации?',
                            audio: 'assets/audio/ru/9.mp3',
                        }
                    ]
                }
            },
            {
                ...
                interactive: {
                    ...
                    items: [
                        {
                            video: {
                                src: 'assets/video/Animation_05.mp4',
                            },
                            text: 'Передача информации – физический процесс, по средствам которого осуществляется перемещение информации в пространстве. ',
                            audio: 'assets/audio/ru/10.mp3',
                        },
                        {
                            video: {
                                src: 'assets/video/Animation_06.mp4',
                            },
                            text: 'Передача информации предполагает наличие двух объектов – источника информации и ее потребителя, приёмника информации. Также необходима среда – канал связи.',
                            audio: 'assets/audio/ru/11.mp3',
                        }
                    ]
                }
            },
